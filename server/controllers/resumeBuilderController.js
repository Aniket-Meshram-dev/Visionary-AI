...
\`\`\`json
{
  ...
  "ats_metrics": {
    ...
    "measurable_impact_pct": 75,
    "action_verb_score": 94,
    "formatting_score": 96,
    "matched_keywords": ["React", "PostgreSQL", "Node.js", "Docker"],
    "missing_verified_skills": ["AWS S3", "GraphQL"],
    "transparent_breakdown": {
      "strengths": ["Strong action verbs across all bullets", "Clear semantic section hierarchy"],
      "areas_to_improve": ["Add more verified scale metrics to older projects if available"]
    }
  }
}
\`\`\``;
